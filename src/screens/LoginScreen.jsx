      ...
      <div className="relative z-10 w-full max-w-sm">
        ...
        <div className="grid grid-cols-3 gap-3 mb-10">
          <div className="bg-slate-800 rounded-2xl p-4 text-center">
            ...
            <p className="text-slate-400 text-xs font-medium">AI Plans</p>
          </div>
          <div className="bg-slate-800 rounded-2xl p-4 text-center">
            <div className="text-2xl mb-1">📊</div>
            <p className="text-slate-400 text-xs font-medium">Track PRs</p>
          </div>
          <div className="bg-slate-800 rounded-2xl p-4 text-center">
            <div className="text-2xl mb-1">🔥</div>
            <p className="text-slate-400 text-xs font-medium">Streaks</p>
          </div>
        </div>
